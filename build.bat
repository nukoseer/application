...
%compiler% %common_compiler_flags% %clang_compiler_flags% %object_flags% %win32_defines% %all_include% ..\source\os\os_log.c ..\source\os\os_io.c ..\source\os\os_time.c ..\source\os\os_memory.c ..\source\os\os_window.c ..\source\os\os.c ..\source\win32\win32_io.c ..\source\win32\win32_time.c ..\source\win32\win32_memory.c ..\source\win32\win32_window.c ..\source\win32\win32.c

%ar% mem.obj os_log.obj os_io.obj os_time.obj os_memory.obj os_window.obj os.obj win32_io.obj win32_time.obj win32_memory.obj win32_window.obj win32.obj /out:os.lib
