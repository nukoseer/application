...
%compiler% %common_compiler_flags% %clang_compiler_flags% %os_includes% %common_includes% ..\source\application.c ..\source\common\mem.c
...
%ar% mem.obj os_memory.obj os_window.obj os_timer.obj os.obj win32_timer.obj win32_memory.obj win32.obj /out:os.lib

%linker% /debug application.obj mem.obj /out:application.exe os.lib User32.lib Winmm.lib /SUBSYSTEM:WINDOWS /ENTRY:mainCRTStartup /wholearchive:clang_rt.asan-x86_64.lib
