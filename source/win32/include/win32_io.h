...
b32 win32_io_file_get_creation_time(uptr file_handle, struct OSDateTime* os_date_time);
b32 win32_io_file_get_last_access_time(uptr file_handle, struct OSDateTime* os_date_time);
b32 win32_io_file_get_last_write_time(uptr file_handle, struct OSDateTime* os_date_time);
